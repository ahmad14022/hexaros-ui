<template>
   <section class="bg-white ">
        <div class="container px-5 py-10 mx-auto">
          ...
          <div
            class="grid grid-cols-1 gap-4 mt-5 xl:mt-10 md:grid-cols-2 xl:grid-cols-3"
          >
            <div
            ...
            >
              <img
                class="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300 w-10px"
                :src="member.avatar"
                alt=""
              />
              ...
              <p class="mt-2 text-gray-500 capitalize">{{ member.role }}</p>
              ...
              <div class="flex mt-3 -mx-2">
                ...
                >
                  <svg
                    ...
                    width="16"
                    height="16"
                    :fill="member.linkedin ? '#374151' : '#d1d5db'"
                ...
                >
                  <svg
                    ...
                    width="16"
                    height="16"
                    :fill="member.github ? '#374151' : '#d1d5db'"
                    class="bi bi-github"
                    viewBox="0 0 16 16"
                  >
                    <path
...
export default {
    ...
    return {
      team: [
        ...
        {
          name: 'Muffida Kurnalia Y P',
          role: 'Hardware Engineer',
          avatar: 'assets/images/team/muffida.png',
        ...
        },
        {
          ...
          avatar: 'assets/images/team/ahyar.png',
          github: 'https://github.com/',
          linkedin:
        ...
        },
        {
          ...
          avatar: 'assets/images/team/faisal.png',
          github: 'https://github.com/',
          linkedin: 'https://www.linkedin.com/',
        },
          {
          name: 'Golden Romensen Modok',
          role: '3D Designer',
          avatar: 'assets/images/team/golden.png',
          github: 'https://github.com/',
          linkedin: 'https://www.linkedin.com/',
        },
      ],
