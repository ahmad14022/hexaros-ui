<template>
  <div class="card p-2">
    <div id="map" class="flex justify-center items-center
      ...
      <img v-if="!robotConnected" src="assets/images/map/hexaros.png" />
    </div>
  </div>
</template>
<script>
export default {
  ...
  methods: {
    ...
    //   //Dibuat fungsi untuk bergerak ke depan turtlebot                                             
    //   function pubMessage() {
    //     //Buat variabel yang akan dikaitkan dengan tujuan                                
    ...
    //     //Kirim tujuan ke server untuk mengeksekusi panggilan balik
    //     goal.send();
